                        ...
                        foreach ($user->readAll($id) as $value => $key) {
                            ...
                            <tr>
                                ...
                                <td class="text-center" >
                                    <a href="teacher.php?action=edit&id=<?php echo $key['id']; ?>" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></a> || 
                                    <a href="teacher.php?action=delete&id=<?php echo $key['id']; ?>" class="btn btn-warning"><span class="glyphicon glyphicon-trash"></span></a></td>
                            </tr>   
                            <?php
                        }
                        ?>
